...
class _PromptsScreenState extends State<PromptsScreen> {
  ...
  static final _categories = [
    ...
    _PromptCategory(
      ...
      prompts: [
        _Prompt('Amélioration de texte', 'Améliore ce texte en termes de clarté, style et grammaire :\n\n[TEXTE ICI]'),
    ...
    _PromptCategory(
      ...
      prompts: [
        _Prompt('Analyse critique', 'Effectue une analyse critique de ce contenu :\n\n[CONTENU ICI]'),
        _Prompt('Comparaison', 'Compare et contraste ces deux éléments :\nÉlément 1 : [X]\nÉlément 2 : [Y]'),
        _Prompt('Débogage', 'Analyse cette erreur et propose des solutions :\n\nErreur : [MESSAGE]\nContexte : [CONTEXTE]'),
      ],
    ),
    _PromptCategory(
      name: 'Créativité',
      ...
      prompts: [
        ...
        _Prompt('Storytelling', 'Écris une courte histoire avec :\nPersonnage : [X]\nSetting : [Y]\nProblème : [Z]'),
    ...
    _PromptCategory(
      ...
      prompts: [
        ...
        _Prompt('Apprentissage', 'Crée un plan d\'apprentissage 30 jours pour maîtriser : [SUJET]'),
        _Prompt('Prompt système', 'Crée un prompt système pour un assistant spécialisé dans : [DOMAINE]'),
      ],
    ),
  ];
  ...
  Widget build(BuildContext context) {
    final tips = [
      ...
      (Icons.send, 'Envoyez directement au Chat',
          'Le bouton "Envoyer au Chat" transfère le prompt dans l\'écran Chat Grok pour tester immédiatement avec l\'API.'),
