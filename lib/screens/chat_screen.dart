...
class _ChatScreenState extends State<ChatScreen> {
  ...
  static const _convKey = 'grok_conversations';
    ...
    final textMessages = _history.map((m) {
      ...
      if (content is List) {
        final texts = content
            ...
            .join('');
        textContent = texts.isEmpty ? '[Image]' : texts;
      } else {
  ...
  Future<void> _sendMessage() async {
    ...
    if (_pendingImage != null) {
      ...
      final ext = _pendingImage!.name.split('.').last.toLowerCase();
    ...
    setState(() {
      _display.add(_Msg(role: 'user', content: text, imagePath: imagePath));
  ...
  void _exportConversation() {
    ...
    sb.writeln('Conversation Grok ($_selectedModel)');
    ...
    for (final msg in _display) {
      ...
      final role = msg.role == 'user'
          ...
          : msg.role == 'assistant'
              ...
              : 'Erreur';
      sb.writeln('\n[$role]');
      if (msg.imagePath != null) sb.writeln('[Image]');
      if (msg.content.isNotEmpty) sb.writeln(msg.content);
    }
    Share.share(sb.toString(), subject: 'Conversation Grok');
  }
          ...
          Container(
            ...
            child: const Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text(
                  'Discutez directement avec Grok via l\'API xAI. Supporte tous les modèles, images et historique.',
              ...
              children: [
                ...
                Expanded(
                  child: Text('Image prête à envoyer',
                      style: TextStyle(
                          color: context.accentLight, fontSize: 12)),
                ),
                IconButton(
                  icon: Icon(Icons.close, color: context.accentMid, size: 18),
          ...
          child: Row(
            ...
            children: [
              IconButton(
                ...
                icon: Icon(Icons.image_outlined, color: context.accentMid),
                padding: const EdgeInsets.all(6),
                constraints: const BoxConstraints(),
