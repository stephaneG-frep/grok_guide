...
import 'screens/aurora_screen.dart';
...
class ThemeConfig {
  ...
  static const darkGray = ThemeConfig(
    ...
    navItems: [
      ...
      NavItem(icon: Icons.auto_awesome_outlined, label: 'Aurora & Live X',  color: Color(0xFFB0B0B0)),
      NavItem(icon: Icons.apps_outlined,         label: 'Applications',    color: Color(0xFF9E9E9E)),
      NavItem(icon: Icons.quiz_outlined,         label: 'Quiz',            color: Color(0xFF808080)),
      NavItem(icon: Icons.hub_outlined,           label: 'IA & Agents',     color: Color(0xFFB0B0B0)),
    ],
  );
  ...
  static const lightGray = ThemeConfig(
    ...
    navItems: [
      ...
      NavItem(icon: Icons.auto_awesome_outlined, label: 'Aurora & Live X',  color: Color(0xFF424242)),
      NavItem(icon: Icons.apps_outlined,         label: 'Applications',    color: Color(0xFF757575)),
      NavItem(icon: Icons.quiz_outlined,         label: 'Quiz',            color: Color(0xFF424242)),
      NavItem(icon: Icons.hub_outlined,           label: 'IA & Agents',     color: Color(0xFF616161)),
    ],
  );
}
